...
public enum EventType {
    ...
    private static class EventProperties {
        protected static final List<String> USER_ACCOUNT_DISABLED = Arrays.asList("USER", "USER_TYPE", "LOGIN_TIME", "ACCOUNT_DISABLED");
        protected static final List<String> USER_ACCOUNT_ENABLED = Arrays.asList("USER", "USER_TYPE", "LOGIN_TIME", "ACCOUNT_ENABLED");
        protected static final List<String> CERTIFICATE = Arrays.asList("ALIAS", "EXPIRATION_DATE");
        protected static final List<String> PASSWORD_EXPIRATION = Arrays.asList("USER", "USER_TYPE", "EXPIRATION_DATE");
    }
}
