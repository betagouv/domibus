...
public class CorePropertyMetadataManagerImpl implements DomibusPropertyMetadataManagerSPI {
    ...
    private Map<String, DomibusPropertyMetadata> knownProperties = Arrays.stream(new DomibusPropertyMetadata[]{
            ...
            new DomibusPropertyMetadata(DOMIBUS_VALID_STRING_PATTERN, Type.REGEXP, Usage.DOMAIN, true),
            ...
            new DomibusPropertyMetadata(DOMIBUS_DISPATCHER_HTTP_HEADER_METADATA_ACTIVE, Type.BOOLEAN, Usage.DOMAIN, true),
            ...
            new DomibusPropertyMetadata(DOMIBUS_PROPERTY_BACKUP_PERIOD_MIN, Type.POSITIVE_INTEGER, Usage.GLOBAL_AND_DOMAIN, true),
