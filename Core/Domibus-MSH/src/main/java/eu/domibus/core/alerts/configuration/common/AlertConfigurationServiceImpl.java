...
public class AlertConfigurationServiceImpl implements AlertConfigurationService {
    ...
    private AlertConfigurationManager createConfigurationManager(AlertType alertType) {
        ...
        LOG.info("Could not create a configuration manager for alert [{}] because the category [{}] doesn't have a configuration manager or property specified.", alertType, alertCategory);
        return null;
    }
