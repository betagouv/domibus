...
public class TruststoreResourceBaseTest {
    ...
    public void replaceTruststoreOK(@Injectable KeyStoreContentInfo storeInfo) {
        ...
        truststoreResourceBase.uploadStore(multiPartFile, pass, allowChangingDiskStoreProps);
    ...
    public void testUploadTruststoreEmpty() {
        ...
        try {
            truststoreResourceBase.uploadStore(emptyFile, "pass", allowChangingDiskStoreProps);
            Assertions.fail();
    ...
    void testUploadTruststoreException(@Injectable KeyStoreContentInfo storeInfo) {
        ...
        Assertions.assertThrows(CryptoException. class,() -> truststoreResourceBase.uploadStore(multiPartFile, "pass", allowChangingDiskStoreProps));
    }
    ...
    public void uploadTruststoreFile_rejectsWhenNoPasswordProvided(@Injectable MultipartFile multipartFile) {
        ...
        try {
            truststoreResourceBase.uploadStore(multipartFile, emptyPassword, allowChangingDiskStoreProps);
            Assertions.fail();
        } catch (RequestValidationException ex) {
