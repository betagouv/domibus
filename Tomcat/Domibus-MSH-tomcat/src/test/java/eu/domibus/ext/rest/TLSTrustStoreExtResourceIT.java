...
public class TLSTrustStoreExtResourceIT extends TrustStoreExtResourceBaseIT {
    ...
    public void add() throws Exception {
        ...
        //then
        String content = result.getResponse().getContentAsString();
        Assertions.assertEquals("Certificate [red_gw] has been successfully added to the TLS truststore.", content);
    }
    ...
    public void delete() throws Exception {
        ...
        //then
        String content = result.getResponse().getContentAsString();
        Assertions.assertEquals("Certificate [blue_gw] has been successfully removed from the [TLS.truststore].", content);
    }
