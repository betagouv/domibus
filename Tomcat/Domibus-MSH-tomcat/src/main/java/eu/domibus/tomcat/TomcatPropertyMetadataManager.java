...
public class TomcatPropertyMetadataManager implements DomibusPropertyMetadataManagerSPI {
    ...
    private Map<String, DomibusPropertyMetadata> knownProperties = Arrays.asList(
            ...
            DomibusPropertyMetadata.getReadOnlyGlobalProperty(DOMIBUS_DATASOURCE_REPLICA_DRIVER_CLASS_NAME, Type.CLASS),
            DomibusPropertyMetadata.getReadOnlyGlobalProperty(DOMIBUS_DATASOURCE_REPLICA_URL, Type.URI),
            DomibusPropertyMetadata.getReadOnlyGlobalProperty(DOMIBUS_DATASOURCE_REPLICA_USER),
            DomibusPropertyMetadata.getReadOnlyGlobalProperty(DOMIBUS_DATASOURCE_REPLICA_PASSWORD, Type.PASSWORD, true),
            DomibusPropertyMetadata.getReadOnlyGlobalProperty(DOMIBUS_DATASOURCE_REPLICA_MAX_LIFETIME, Type.NUMERIC),
            DomibusPropertyMetadata.getReadOnlyGlobalProperty(DOMIBUS_DATASOURCE_REPLICA_MAX_POOL_SIZE, Type.NUMERIC),
            DomibusPropertyMetadata.getReadOnlyGlobalProperty(DOMIBUS_DATASOURCE_REPLICA_CONNECTION_TIMEOUT, Type.NUMERIC),
            DomibusPropertyMetadata.getReadOnlyGlobalProperty(DOMIBUS_DATASOURCE_REPLICA_IDLE_TIMEOUT, Type.NUMERIC),
            DomibusPropertyMetadata.getReadOnlyGlobalProperty(DOMIBUS_DATASOURCE_REPLICA_MINIMUM_IDLE, Type.NUMERIC),
            DomibusPropertyMetadata.getReadOnlyGlobalProperty(DOMIBUS_DATASOURCE_REPLICA_POOL_NAME, Type.STRING),
